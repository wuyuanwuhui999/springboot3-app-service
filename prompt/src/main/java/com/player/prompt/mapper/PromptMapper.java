...
public interface PromptMapper {
    PromptEntity getPrompt(String userId,String tenantId,String promptId);
    ...
    List<PromptEntity> getPromptList(String tenantId, String userId, String keyword,int pageSize,int offset);

    Long getPromptListCount(String tenantId, String userId, String keyword);
}