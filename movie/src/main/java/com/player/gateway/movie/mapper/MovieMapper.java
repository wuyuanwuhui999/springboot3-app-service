package com.player.gateway.movie.mapper;

import com.player.gateway.common.entity.LogEntity;
import com.player.gateway.common.entity.SearchHistory;
import com.player.gateway.movie.entity.MovieEntity;
import com.player.gateway.movie.entity.MovieStarEntity;
import com.player.gateway.movie.entity.MovieUrlEntity;
...
public interface MovieMapper {
    ...
    Long saveFavorite(int movieId, String userId);

    Long deleteFavorite(int movieId,String userId);
